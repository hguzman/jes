...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { apellido: @resume.apellido, cedula: @resume.cedula, direccion: @resume.direccion, email: @resume.email, nombre: @resume.nombre }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { apellido: @resume.apellido, cedula: @resume.cedula, direccion: @resume.direccion, email: @resume.email, nombre: @resume.nombre }
    assert_redirected_to resume_path(assigns(:resume))
  end
